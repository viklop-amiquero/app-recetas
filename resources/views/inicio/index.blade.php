        ...
        <form action="{{route('buscar.show')}}" class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-md-4 texto-buscar">
                    <p class="display-4">Encuentra una receta para tu prósicma comida</p>
                    <input 
                        type="search"
                        name="buscar"
                        class="form-control"
...
@section('content')
    ...
    {{-- <img src="{{asset('/images/verduras.jpg')}}" alt=""> --}}
            ...
            @foreach($nuevas as $nueva)
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{route('recetas.show', ['receta' => $nueva->id])}}" class="btn btn-primary d-block font-weight-bold text-uppercase text-light">
                            Ver Receta
                        </a>
                    </div>
                </div>
